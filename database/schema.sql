...
ALTER TABLE ARDUINO MODIFY COLUMN id INT AUTO_INCREMENT COMMENT 'Id del arduino';
...
ALTER TABLE LECTURA MODIFY COLUMN id INT AUTO_INCREMENT COMMENT 'Id de la lectura';
...
ALTER TABLE RUTA MODIFY COLUMN id INT AUTO_INCREMENT COMMENT 'Id de la ruta';
...
ALTER TABLE PUNTO_DE_CONTROL MODIFY COLUMN id INT AUTO_INCREMENT COMMENT 'Id del punto de control';
...
ALTER TABLE VUELTA MODIFY COLUMN id INT AUTO_INCREMENT COMMENT 'Id de la vuelta';
...
ALTER TABLE TIEMPO MODIFY COLUMN id INT AUTO_INCREMENT COMMENT 'Id de la lectura de tiempo';
